"""
Django settings for bot_telegram_wallet project.
...
SECRET_KEY = 'django-insecure-l&#4vej8*o-(x4^k9)e)ead+f9-af^5!+$02wty6omv*e0o$s9'
...
ROOT_URLCONF = 'bot_telegram_wallet.urls'
...
WSGI_APPLICATION = 'bot_telegram_wallet.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'CONN_MAX_AGE': 60,  # ⬅️ اتصال‌ها ۶۰ ثانیه زنده می‌مانند
        'OPTIONS': {
